...
import styles from './MyIcon.module.css'; // Import the CSS module

export const MyIcon = () => {
  return (
    <div className={styles.iconWrapper}> {/* Wrapper for aligning */}
      <svg
        className={styles.icon} // Apply the icon styling
        width="24"
        height="24"
        viewBox="0 0 24 24"
        strokeWidth="1.5"
